...
<!-- Here's the script that *should* get the relevant members from the search. Note search string must be greater than 2 -->		
		<script>
			function showResult(str) {
			  ...
			  xmlhttp.open("GET","template/livesearch.php?house=<?php echo $house ?>&searchby=<?php echo $searchby ?>&q="+str,true);
			  xmlhttp.send();
			}
			</script>
      ...
      <div class="col-sm-4 bootcards-list" id="list" data-title="Contacts">
        <div class="panel panel-default">       
          <div class="panel-body">
            ...
            <div class="search-form">
				...
				<input id="searchby" <?php if ($searchby == "constituency") {echo "checked";} ?> type="checkbox" value="constituency" name="searchby" form="mpsearch" data-toggle="toggle" data-on="Constituency" data-off="Name">
		...
		<?php 
			...
			if ($house == "Lords") {
          	...
          	if (!$q){
				echo file_get_contents("template/initiallist".$iflords.".php"); 
            }
            else {
