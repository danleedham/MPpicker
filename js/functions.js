...
function qsloadsuggestedgroups(date){
   $("#suggested-groups").load('template/qs-commonsgroupsauto.php?output=true&date='+date);
   console.log('Loading suggested groups for: '+date);
}	
