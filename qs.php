							...
							<div class="search-form" id="menu">
								...
								<div class="form-inline" style="padding-top:6px !important;">
									...
									<?php else: ?>
									    ...
									    <?php else: ?>
									<select id="dept-input" onchange="qsloadtypes(); qsloadsuggestedgroups(document.getElementById('date-input').value,encodeURI(this.value))" name="type" class="form-control">
										<option value="">Loading Departments...</option>
									</select>	
									    <?php endif; ?>
									<?php endif; ?>
